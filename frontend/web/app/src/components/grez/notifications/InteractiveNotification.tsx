...
export const InteractiveNotification: React.FC<NotificationProps> = ({ 
  ...
  // Estilos base
  const baseStyles = "fixed bottom-4 right-4 flex items-center p-4 rounded-lg shadow-md max-w-xs z-50 border-l-4 cursor-pointer";
  ...
  const typeStyles = {
    ...
    warning: "bg-yellow-50 border-yellow-500 text-yellow-800 hover:bg-yellow-100",
  ...
  return (
    <>
      ...
      {/* Chat flotante */}
      {isChatOpen && (
        <div className="fixed bottom-20 right-4 w-80 h-96 bg-white rounded-lg shadow-xl z-50 flex flex-col border border-gray-200">
          {/* Header del chat */}
