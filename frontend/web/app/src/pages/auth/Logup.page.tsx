  ...
  <div className="bg-white rounded-lg shadow-lg p-8 max-w-md w-full border border-[#e0e0e0]">
    ...
    {!isSignUpSubmitted ? (
      <form onSubmit={handleLogup} className="space-y-6">
        <div>
          <label htmlFor="email" className="block text-sm font-medium text-[#072146]">
            Correo electrónico
          </label>
          <input
            type="email"
        ...
        <div>
          <label htmlFor="password" className="block text-sm font-medium text-[#072146]">
            Contraseña
          </label>
          <input
            type="password"
        ...
        <div>
          <label htmlFor="name" className="block text-sm font-medium text-[#072146]">
            Nombre completo
          </label>
          <input
            type="text"
        ...
        <div>
          <label htmlFor="nickname" className="block text-sm font-medium text-[#072146]">
            Apodo
          </label>
          <input
            type="text"
        ...
        {isAuthenticated && (
          <div className="bg-[#f6f7f8] p-4 rounded-lg border border-[#e0e0e0]">
            <label htmlFor="role" className="block text-sm font-medium text-[#072146] mb-2">
              Seleccione su rol
            </label>
            <select
              id="role"
      ...
      <form onSubmit={handleConfirmation} className="space-y-6">
        <div>
          ...
          <label htmlFor="confirmationCode" className="block text-sm font-medium text-[#072146] mt-4">
    ...
    <div className="mt-6 text-center text-sm text-[#072146]">
      {isSignUpSubmitted ? (
        <button onClick={() => setIsSignUpSubmitted(false)} className="text-[#00a0d2] font-medium hover:underline">
          Volver a registro
        </button>
      ) : (
        <div className="grid grid-cols-1 gap-2">
          {!isAuthenticated && (
            <Link to="/login" className="text-[#00a0d2] font-medium hover:underline">
              ¿Ya tienes cuenta? Inicia sesión
            </Link>
          )}
          <button onClick={() => setIsSignUpSubmitted(true)} className="text-[#00a0d2] font-medium hover:underline">
