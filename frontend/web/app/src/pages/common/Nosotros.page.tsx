    ...
    <div className="w-full min-h-screen bg-gray-900 text-white font-sans">
      ...
      <div className="relative w-full h-[80vh] overflow-hidden">
        ...
        <div className="absolute inset-0 bg-black bg-opacity-50 flex flex-col items-center justify-center text-center px-4">
          ...
          >
            Revolucionando las entregas con drones inteligentes, sustentables y autónomos.
          </motion.p>
        </div>
      ...
      <div className="max-w-7xl mx-auto px-8 py-24 space-y-24">
        ...
        >
          <h2 className="text-4xl font-bold text-white">¿Por qué nace Aviren?</h2>
          <p className="text-lg text-gray-300">
            Aviren surge como una solución frente a los problemas de lentitud, ineficiencia y contaminación
            presentes en los métodos de entrega tradicionales. Al emplear drones eléctricos con algoritmos de
            optimización, reducimos tiempos de entrega y disminuimos la huella de carbono. Nuestro objetivo es
            transformar la logística en ciudades modernas como Tehuacán.
          </p>
        </motion.section>
        ...
        <motion.section
          ...
          transition={{ duration: 0.8 }}
        >
          <h2 className="text-4xl font-bold text-white">¿A quién va dirigido?</h2>
          <p className="text-lg text-gray-300">
            Nuestro servicio está pensado para negocios locales como restaurantes, farmacias y tiendas de
            abarrotes, así como plataformas de e-commerce y usuarios particulares. Nos enfocamos en la ciudad
            de Tehuacán y sus alrededores, llevando tecnología accesible a comunidades que desean modernizar
            sus entregas.
          </p>
        </motion.section>
        ...
        >
          ...
          <div className="bg-gray-800 p-6 rounded-2xl shadow-lg hover:scale-105 transition">
            ...
            <p className="text-gray-300 mt-2">
              Navegación milimétrica gracias a sensores y posicionamiento avanzado.
            </p>
          </div>
        </motion.section>
        ...
        <motion.section
          ...
          transition={{ duration: 0.8 }}
        >
          <h2 className="text-3xl font-semibold text-white">¿Te interesa saber cómo funciona?</h2>
          <p className="text-gray-400">
            Mira este breve tutorial para conocer cómo funciona nuestra aplicación de entregas.
          </p>
